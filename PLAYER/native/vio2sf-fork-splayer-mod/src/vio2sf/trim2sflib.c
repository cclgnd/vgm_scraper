...
int main(int argc, char ** argv)
{
    if (argc < 3) {
        ...
        fprintf(stderr, "\n");
        fprintf(stderr, "Usage: %s file.2sflib 1.mini2sf 2.mini2sf ...\n", argv[0]);
        return 1;
    }
    ...
    for (i = 2; i < argc; ++i)
    {
        ...
        fprintf(stderr, "ran for %d samples, covering " PRIzu " words\n", total_rendered, last_bits_set);
    }
    
    {
        ...
        fprintf(stderr, "ROM size: " PRIzu " bytes\n", rom_bit_count * 4);
        ...
        fprintf(stderr, "New ROM uncompressed size: " PRIzu "\n", rom_pointer - rom_block);
        ...
        fprintf(stderr, "New compressed ROM size: " PRIzu "\n", z.total_out);
